...
// ── Main form ────────────────────────────────────────────────────────────────
export default function JobPostForm({ company }) {
  ...
  // ── Validation ─────────────────────────────────────────────────────────────
  // NOTE: only validates fields that are actually rendered in this component
  // (job details). Company info fields were removed from here since the
  // "company" object is now passed in directly as a prop.
  const validate = (data) => {
    const e = {};
